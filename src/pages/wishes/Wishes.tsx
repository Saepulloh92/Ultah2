...
const sampleMessagesDataArray: TMessagesData[] = [
  {
    ...
    messageInParas: [
      "Hey there Devi Surya Indah, it's your birthday! Wishing you the happiest of birthdays filled with all the things you love and cherish the most.",
      ...
      "You're a true gem, Devi, and I feel lucky to know you. Happy birthday and cheers to a fantastic year ahead!",
    ],
